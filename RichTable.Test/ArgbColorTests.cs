...
namespace Richx.Test
{
    public class ArgbColorTests
    {
        ...
        public void FromArgbTest()
        {
            ...
            Assert.Equal(0x80112233, color.Value);
            Assert.Equal(0x80112233, color.ArgbValue);
        }

        [Fact]
        public void ValueTest1()
        {
            var color = new ArgbColor(0x80112233);
            Assert.Equal(0x11, color.Red);
            Assert.Equal(0x22, color.Green);
            Assert.Equal(0x33, color.Blue);
            Assert.Equal(0x80, color.Alpha);
        ...
        {
            var color = new ArgbColor(0x80, 0x11, 0x22, 0x33);
            Assert.Equal(0x11, color.Red);
            Assert.Equal(0x22, color.Green);
            Assert.Equal(0x33, color.Blue);
            Assert.Equal(0x80, color.Alpha);
        ...
        public void AssignmentTest()
        {
            ...
            Assert.Equal(0x80112233, color1.ArgbValue);
